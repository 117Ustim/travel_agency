        ...
        <div className={styles.rectangle}>
          <div className={styles.rectCol}>
            <div className={styles.rectHeader}>
              <Image
                src="/rectangle/icon_rectangle/icon_1.png"
                alt="Destination"
                width={9}
                height={17}
                quality={90}
          ...
          <div className={styles.rectCol}>
            <div className={styles.rectHeader}>
              <Image
                src="/rectangle/icon_rectangle/icon_2.png"
                alt="Travel type"
                width={16}
                height={16}
                quality={90}
          ...
          <div className={styles.rectCol}>
            <div className={styles.rectHeader}>
              <Image
                src="/rectangle/icon_rectangle/icon_3.png"
                alt="When"
                width={16}
                height={15}
                quality={90}
          ...
          <div className={styles.rectCol}>
            <div className={styles.rectHeader}>
              <Image
                src="/rectangle/icon_rectangle/icon_4.png"
                alt="Travellers"
                width={15}
                height={16}
                quality={90}
          ...
          <button type="button" className={styles.findButton}>
            ...
            >
              <path
                fill="currentColor"
                d="M15.5 14h-.79l-.28-.27a6.471 6.471 0 0 0 1.57-4.23C15.99 6.01 12.98 3 9.5 3S3 6.01 3 9.5 6.01 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"
              />
            </svg>
            FIND
          </button>
