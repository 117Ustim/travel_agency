    ...
    const markActiveFirstVisible = () => {
        ...
        if (root) {
            ...
            if (firstVisible) {
                ...
                const activeBar = root.querySelector(`.${styles.navBar}[data-idx="${idx}"]`);
        ...
        <div className={styles.carousel} ref={rootRef}>
            <div className={styles.track} ref={trackRef}>
                {allItems.map((item, idx) => (
                    <div className={styles.card} key={`${item.id}-${idx}`} data-idx={idx % items.length}>
            ...
            <div className={styles.navBars} role="tablist" aria-label="Carousel navigation">
                {items.map((_, idx) => (
                    <button
                        key={`bar-${idx}`}
                        type="button"
